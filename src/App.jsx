...
function Hero() {
  ...
  return (
    <div style={{ height:"100%", display:"flex", flexDirection:"column", overflow:"hidden", position:"relative" }}>
      ...
      <div style={{ position:"relative", zIndex:2, flex:1, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
        ...
        <div style={{ width:"clamp(60px,20vw,120px)", height:"1px", margin:"16px 0 0", background:"linear-gradient(90deg,transparent,var(--gold),transparent)", animation:after?"lineExpand 0.8s ease forwards":"none", opacity:after?undefined:0, transformOrigin:"center" }}/>
        <div style={{ maxWidth:"600px", width:"100%", padding:"clamp(20px,3vh,32px) clamp(20px,5vw,40px) 0", opacity:after?1:0, transition:"opacity 1.2s ease 0.5s" }}>
          {lines.map((line, i) => {
            const q = isQ(line);
            return (
              <p key={i} style={{
